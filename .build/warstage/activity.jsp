...
<html lang="ms">
    <head>
        ...
        <%-- FullCalendar styles are bundled in index.global.min.js (v6) --%>
        <style>
            :root{
                --green:#0b8a83;
                --green-dark:#056d67;
    ...
    <body>
        ...
        <script src="${pageContext.request.contextPath}/vendor/fullcalendar/index.global.min.js"></script>
        <script src="${pageContext.request.contextPath}/vendor/fullcalendar/locales-ms.global.min.js"></script>
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                if (typeof FullCalendar === 'undefined') {
                    calEl.innerHTML = '<p style="padding:16px;color:#b91c1c;">Kalendar gagal dimuatkan. Sila muat semula halaman.</p>';
                    return;
                }
                try {
                    ...
                    calEl.innerHTML = '<p style="padding:16px;color:#b91c1c;">Kalendar gagal dipaparkan.</p>';
                }
            });
        </script>
